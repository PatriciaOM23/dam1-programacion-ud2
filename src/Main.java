...
public class Main {
    public static void main(String[] args) {
       ...
       /*     cuenta.depositar(100);
        ...
        // Tu código aquí ↓
        // cuenta.registrarOperacion("Hackeo", 2000);
        // ================================
        // EJERCICIO 4: Libre
        // ================================
        ...
        cuenta.depositar(100);
        cuenta.depositar(20);
        //No funciona cuenta.getSaldo a solas porque es una operacion para que vea el usuario no para nosotros mismos
...
// Respuesta: Porque es una clase privada

// Ejercicio 2: ¿por qué sí puedo usar los métodos depositar(), retirar() y getSaldo()?
// Respuesta: Porque son clases públicas

// Ejercicio 3: ¿qué significa el error al intentar llamar a registrarOperacion()?
// Respuesta: Que "no existe" ya que es una clase privada entonces para el usuario "no existe" y por ese no se le puede llamar.

// Ejercicio 4: 
// - ¿Qué ventajas tiene que saldo sea private?
// Que no cualquiera puede acceder al saldo ajeno
// - ¿Qué pasaría si saldo fuera public?
// Que todos podrían acceder a mi saldo
// - ¿Por qué registrarOperacion es private en lugar de public?
// Respuesta: Porque quiero que sea una operación interna que no se muestre al usuario 
